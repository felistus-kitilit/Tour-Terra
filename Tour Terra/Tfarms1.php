...
if ($result->num_rows > 0) {
    ...
    // Store Farmer and Farm Name in session
...
<body>
    ...
    <?php echo "$percentage%, ($totalRatings ratings)"; ?>
                ...
                <label id="name" for="name"> <?php echo htmlspecialchars($farm['Name']); ?> </label><br/><br/>
                    ...
                    <input type="hidden" id="farmer" name="farmer" value="<?php echo htmlspecialchars($farm['Farmer']); ?>"readonly>
                </div>
